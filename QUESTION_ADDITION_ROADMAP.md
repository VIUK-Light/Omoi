...
> **履歴文書:** この文書中の件数と「今回追加しない」という記述は、基準コミット `e2c0d73` 時点の計画です。現在のデータスキーマ・品質基準は [QUESTION_DATA_SCHEMA.md](QUESTION_DATA_SCHEMA.md) と `tools/verify-question-dataset.mjs` を正とします。
